...
export const PostList = ({title, description, posts, imgUrl, imgAlt, categoryTitle, arrayPrincipalPost, arrayPost}) => {
  return (
    <Fragment>
			{/* Geeks SEO settings */}
			<HermenautasSEO title={title} description={description} imgUrl={imgUrl} imgAlt={imgAlt} posts={posts} />
      ...
      <section className="pb-8 bg-white">
        <Container>
          <Row>
            ...
            {arrayPrincipalPost.filter(function (dataSource) {
