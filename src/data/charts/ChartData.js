const theme = {
  primary: 'var(--hermenautas-primary)',
  secondary: 'var(--hermenautas-secondary)',
  success: 'var(--hermenautas-success)',
  info: 'var(--hermenautas-info)',
  warning: 'var(--hermenautas-warning)',
  danger: 'var(--hermenautas-danger)',
  dark: 'var(--hermenautas-dark)',
  light: 'var(--hermenautas-light)',
  white: 'var(--hermenautas-white)',
  gray100: 'var(--hermenautas-gray-100)',
  gray200: 'var(--hermenautas-gray-200)',
  gray300: 'var(--hermenautas-gray-300)',
  gray400: 'var(--hermenautas-gray-400)',
  gray500: 'var(--hermenautas-gray-500)',
  gray600: 'var(--hermenautas-gray-600)',
  gray700: 'var(--hermenautas-gray-700)',
  gray800: 'var(--hermenautas-gray-800)',
  gray900: 'var(--hermenautas-gray-900)',
  black: 'var(--hermenautas-black)',
  lightPrimary: 'var(--hermenautas-light-primary)',
  lightSecondary: 'var(--hermenautas-light-secondary)',
  lightSuccess: 'var(--hermenautas-light-success)',
  lightDanger: 'var(--hermenautas-light-danger)',
  lightWarning: 'var(--hermenautas-light-warning)',
  lightInfo: 'var(--hermenautas-light-info)',
  darkPrimary: 'var(--hermenautas-dark-primary)',
  darkSecondary: 'var(--hermenautas-dark-secondary)',
  darkSuccess: 'var(--hermenautas-dark-success)',
  darkDanger: 'var(--hermenautas-dark-danger)',
  darkWarning: 'var(--hermenautas-dark-warning)',
  darkInfo: 'var(--hermenautas-dark-info)',
  transparent: 'transparent',
  borderColor: 'var(--hermenautas-border-color)',
};
